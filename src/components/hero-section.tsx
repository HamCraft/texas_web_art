...
export default function HeroSection() {
  ...
  return (
    <>
      {/* ✅ SEO meta tags */}
      <Head>
        <title>Texas Web Art - Build. Launch. Grow.</title>
        <meta
          name="description"
          content="We create stunning, functional websites that help your business grow. Starting from $49.99—just bring your domain!"
        />
        <meta
          name="keywords"
          content="web development, Texas Web Art, Dallas, Texas, affordable websites, custom websites, website design, build launch grow"
        />
        <meta name="author" content="Texas Web Art" />
        <meta property="og:title" content="Texas Web Art - Build. Launch. Grow." />
        <meta
          property="og:description"
          content="Web services starting at $49.99. Bring your domain, we’ll do the rest."
        />
        <meta property="og:image" content="/herosec.png" />
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-6">
              ...
              >
                ...
                <span className="text-amber-300 font-semibold">$59.99</span> —
